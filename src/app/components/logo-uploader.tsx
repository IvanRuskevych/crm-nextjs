...
function LogoUploader({ id, label, placeholder, ...rest }: LogoUploaderProps) {
  return (
    <div className="flex gap-10 mb-3">
      ...
      >
        ...
        <input
          {...rest}
          id={id}
          type="file" // цей тип дозволяє обирати файли з системи ПК для подальшого завантаження в BD
          accept="image/*"
          className="hidden"
        />
      </label>
